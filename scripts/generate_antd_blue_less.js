  ...
  less
    .render(lessCode, {
      ...
      modifyVars: {
        ...
        'gold-base': '#d89614',
        'error-color': '#ED5B56',
        'primary-color': '#427AF4',
        'success-color': '#27AD5D',
        'warning-color': '#eda00c',
        'link-color': '#427AF4',
        'tabs-ink-bar-color': '#427AF4',
    ...
    .then(function (output) {
      fs.writeFileSync(filename, `.theme-light-blue { ${output.css} }`);
      callback();
    });
}
...
exec(`cp ${customizeFilePath} ${customizeFilePath}.copy`, () => {
  ...
  saveLess('node_modules/antd/dist/antd.less', 'src/theme/antd.light-blue.less', () => {
