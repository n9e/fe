...
import { TimeZone, InternalTimeZones } from './types';
...
export const getZone = (timeZone: TimeZone) => {
...
export const getTimeZoneInfo = (zone: TimeZone, timestamp: number): TimeZoneInfo | undefined => {
...
export const getTimeZones = memoize((includeInternal: boolean | InternalTimeZones[] = false): TimeZone[] => {
  ...
  if (includeInternal === true) {
    ...
    initial.push(InternalTimeZones.localBrowserTime, InternalTimeZones.utc);
...
export const getTimeZoneGroups = memoize((includeInternal: boolean | InternalTimeZones[] = false): GroupedTimeZones[] => {
...
const mapInternal = (zone: TimeZone, timestamp: number): TimeZoneInfo | undefined => {
  switch (zone) {
