const ja_JP = {
  auth: {
    "403":
      "このページにアクセスする権限がありません。管理者に連絡してください！",
  ...
  datasource: {
    ...
    empty_modal: {
      title:
        "データソースの設定がありません。管理者に連絡してデータソースを追加してください",
      btn1: "設定に移動",
      btn2: "了解",
    },
  },
  ...
  "tpl.account.help":
    "実行アカウント、rootを使用するのは慎用してください。操作システムの意志を代表する場合を除き",
  "tpl.batch.help":
    "並行度、デフォルトは0、全て並行して実行します。1は順次実行、2は2台ずつ実行します",
  "tpl.tolerance.help":
    "許容する失敗台数、デフォルトは0、1台も許容しません。失敗したらすぐに一時停止します",
  "tpl.timeout.help": "単一のスクリプトの実行タイムアウト、単位は秒です",
  "tpl.pause.help": "一時停止ポイント、1台を終えたら一時停止します",
  "tpl.host.help": "実行するマシンのリスト",
  "tpl.host.help2":
    "前提依存：目標マシンにはcategrafをデプロイし、ibexの設定enableをtrueに設定します",
  "tpl.host.filter_btn": "マシンをフィルタ",
  "tpl.script.help": "実行するスクリプトの内容",
  "tpl.args.help":
    "スクリプトの後に付けるパラメータ、複数のパラメータはダブルコンマ,,で区切ります。例：arg1,,arg2,,arg3",
  "tpl.modify": "スクリプトを編集",
  ...
  "task.tip.content":
    "もしロールが管理者なら、どのマシンでもスクリプトを実行できます。それ以外は、管理権限のあるビジネスグループのマシンでのみスクリプトを実行できます",
  "last.7.days": "最近 7 日",
  ...
  request_fail_msg:
    "ネットワークリクエストタイムアウト、しばらくしてから再試行してください",
};
