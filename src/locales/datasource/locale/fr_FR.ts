const fr_FR = {
  "es": {
    ...
    "indexPattern": "Modèle d'index",
    "indexPatterns": "Modèle d'index",
    "indexPattern_msg": "Le modèle d'index est obligatoire",
    "indexPatterns_manage": "Gérer les modèles d'index",
    "filter": "Filtre",
    "index_placeholder": "Index log-* (jokers acceptés)",
    "index_pattern_placeholder": "Choisir un modèle d'index",
