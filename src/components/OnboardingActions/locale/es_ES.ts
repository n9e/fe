const es_ES = {
  ...
  "card": {
    ...
    "rows": {
      ...
      "pack": {
        "title": "Aplicar el dashboard de hosts y activar las alertas de host",
        "desc": "Importa los dashboards y las reglas de alerta integrados con un clic",
  ...
  "pack": {
    ...
    "existing": "(ya existe)",
    "existing_skipped": "El grupo de negocio de destino ya tiene un dashboard con este nombre; se omitirá",
    ...
    "already_imported": "Todos los dashboards seleccionados ya existen en este grupo de negocio; solo se añadirán las reglas de alerta",
    "boards_incomplete": "No se encontró ninguna plantilla de dashboard de hosts integrada; abre «Ver y seleccionar» y elígelas manualmente",
    ...
    "view_board": "Ver el dashboard de hosts",
