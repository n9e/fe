const ko_KR = {
  ...
  "pack": {
    ...
    "notify_rules": "알림 전송 규칙",
    "notify_rules_tip": "알림 전송 규칙을 연결하지 않으면 이벤트는 생기지만 아무에게도 전달되지 않습니다",
    "notify_rules_placeholder": "기존 알림 전송 규칙을 고르거나 위쪽 빠른 생성으로 새로 만드세요",
    "quick_create": "빠른 생성",
    "submit": "한 번에 켜기",
    "view_board": "호스트 대시보드 보기",
    "next_test": "테스트 알림 보내기",
    "no_notify_warning": "이 알림 규칙들에는 알림 전송 규칙이 연결되어 있지 않아, 발생해도 아무에게도 전달되지 않습니다",
  ...
  "notify": {
    "bind_hint": "알림 전송 규칙을 만들었지만 켜져 있는 호스트 알림에 아직 연결되지 않아, 실제 알림은 여전히 아무에게도 전달되지 않습니다"
  },
  "test": {
    "title": "테스트 알림 보내기",
    "rule_label": "어떤 알림 전송 규칙으로 보낼지",
    "send": "테스트 알림 보내기",
    "result_title": "전송 결과",
    "sent": "알림 매체를 호출했으며 응답은 다음과 같습니다",
    "sent_hint": "채팅방이나 메일함에서 이 테스트 메시지가 도착했는지 확인하세요. 도착해야 알림 경로가 실제로 연결된 것입니다",
    "no_rule": "아직 알림 전송 규칙이 없습니다",
    "go_create_rule": "알림 전송 규칙 만들기",
    "rule_without_config": "이 알림 전송 규칙에는 알림 매체가 없어 보낼 수 없습니다",
    "no_channel": "알림 매체를 선택하지 않았습니다",
    "channel_fallback": "알림 매체 {{index}}",
    "go_check_channel": "알림 매체 확인하기",
