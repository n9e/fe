...
const DocSvg = () => {
  return (
    <svg width='1em' height='1em' viewBox='0 0 48 48' fill='none' xmlns='http://www.w3.org/2000/svg'>
      ...
      />
      <path d='M17 12L31 12' stroke='currentColor' stroke-width='4' stroke-linecap='round' stroke-linejoin='round' />
      <path d='M17 20L31 20' stroke='currentColor' stroke-width='4' stroke-linecap='round' stroke-linejoin='round' />
      <path d='M17 28H23' stroke='currentColor' stroke-width='4' stroke-linecap='round' stroke-linejoin='round' />
      <path
...
const DocIcon = (props: Partial<CustomIconComponentProps>) => <Icon component={DocSvg} {...props} />;
