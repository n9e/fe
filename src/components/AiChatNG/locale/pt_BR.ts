const pt_BR = {
  ...
  "dock": {
    ...
    "prompt_log_errors": "Logs de erro, última hora",
    "prompt_log_errors_query": "Escreva um SQL que liste os logs de erro da última hora",
    "prompt_log_per_minute": "Volume de logs por minuto",
    "prompt_log_per_minute_query": "Escreva um SQL que conte logs por minuto na última hora",
    "prompt_log_group": "Contagem por serviço",
    "prompt_log_group_query": "Escreva um SQL que conte logs agrupados por serviço",
    "prompt_search_errors": "Logs de erro, última hora",
    "prompt_search_errors_query": "Encontre os logs de erro da última hora",
    "prompt_search_service": "Logs de um serviço",
    "prompt_search_service_query": "Encontre os logs recentes de um serviço",
    "prompt_search_timeout": "Logs que mencionam timeout",
    "prompt_search_timeout_query": "Encontre os logs que mencionam timeout",
