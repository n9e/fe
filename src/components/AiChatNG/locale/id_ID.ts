const id_ID = {
  ...
  "dock": {
    ...
    "prompt_search_errors": "Log error, satu jam terakhir",
    "prompt_search_errors_query": "Cari log error dari satu jam terakhir",
    "prompt_search_service": "Log satu layanan",
    "prompt_search_service_query": "Cari log terbaru dari satu layanan",
    "prompt_search_timeout": "Log yang menyebut timeout",
    "prompt_search_timeout_query": "Cari log yang menyebut timeout",
