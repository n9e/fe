const zh_HK = {
  ...
  dock: {
    ...
    prompt_log_errors: '最近一小時的錯誤日誌',
    prompt_log_errors_query: '幫我寫一條查最近一小時錯誤日誌的 SQL',
    prompt_log_per_minute: '按分鐘統計日誌量',
    prompt_log_per_minute_query: '幫我寫一條按分鐘統計最近一小時日誌條數的 SQL',
    prompt_log_group: '按服務分組計數',
    prompt_log_group_query: '幫我寫一條按服務欄位分組計數的 SQL',
    prompt_search_errors: '最近一小時的錯誤日誌',
    prompt_search_errors_query: '幫我查最近一小時的錯誤日誌',
    prompt_search_service: '某個服務的日誌',
    prompt_search_service_query: '幫我查某個服務最近的日誌',
    prompt_search_timeout: '包含逾時的日誌',
    prompt_search_timeout_query: '幫我找出包含 timeout 的日誌',
    open: '用 AI 生成查詢',
    close: '關閉',
    expand: '展開',
    collapse: '收起',
