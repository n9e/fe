const zh_HK = {
  ...
  panel: {
    open: '用 AI 生成查詢',
    untitled: "AI 生成查詢",
    intro: "先在目前資料來源上驗證，再把查詢填進上面的輸入框。通常需要半分鐘到一分鐘。",
    based_on: "資料來源：{{name}}",
    running: '生成中',
    adopted: "已填入",
    failed: "失敗",
    close: '關閉',
    step: {
      command: "查了 {{count}} 次資料",
      read_file: "查閱了 {{count}} 份資料",
      edit_file: "寫了 {{count}} 份筆記",
      separator: ' · ',
    },
    ...
    needs_answer: "需要你補充",
    error_detail: "錯誤詳情",
    nothing_delivered: "沒有得到可用的查詢",
    failed_title: "生成失敗",
    failed_hint: "請重試；如果反覆失敗，把下面的錯誤詳情發給管理員。",
    retry: "重試",
    stop: "停止",
    refill: "重新填入",
    restored: "已恢復你原來的內容",
    understanding: "正在理解你的問題…",
    verified_by: "驗證過程：{{detail}}",
    ...
    example_fallback: "每台主機的 CPU 使用率",
    unchanged: "和輸入框裡的內容一致，未做改動",
    no_context: "請先選擇資料來源",
