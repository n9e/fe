const ru_RU = {
  ...
  ui_action: {
    ...
    generating: 'Формируется действие на странице…',
    invalid_json: 'Это действие не является корректным JSON и не может быть выполнено',
    unsupported: 'На текущей странице нет действия «{{name}}»',
    args: 'Параметры',
    execute: 'Выполнить',
