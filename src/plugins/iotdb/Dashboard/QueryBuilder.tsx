...
import { alphabet, DatasourceCateEnum } from '@/utils/constant';
            ...
            {_.map(fields, (field, index) => {
              return (
                ...
                >
                        ...
                        <MetaModal
                          ...
                          onTreeNodeClick={(nodeData) => {
                            ...
                            if (nodeData.levelType === 'field') {
                              _.set(targets, [field.name, 'query', 'query'], `select time, ${nodeData.field} from ${nodeData.table}`);
                              ...
                              _.set(targets, [field.name, 'query', 'query'], `select * from ${nodeData.table}`);
                            }
                            chartForm.setFieldsValue({
                              targets,
                            });
                  ...
                  <AdvancedSettings mode='graph' span={8} prefixField={field} prefixName={[field.name, 'query']} datasourceCate={DatasourceCateEnum.iotdb} />
                </Panel>
              );
            })}
