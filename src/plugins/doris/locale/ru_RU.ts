const ru_RU = {
  ...
  query: {
    ...
    time_field_tip: 'Чтобы связать этот выбор времени, вам нужно использовать временной макрос в условии запроса<br/>Введение в использование временных макросов: <a>Подробнее</a>',
    query: 'Запрос',
