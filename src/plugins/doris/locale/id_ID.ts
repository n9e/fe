const id_ID = {
  ...
  "quick_query_tip": "Kueri cepat membuat pernyataan kueri dari templat SQL yang tetap; misalnya untuk field A lebih dari 0, cukup ketik A > 0. Tombol ini juga membawamu ke mode khusus, tempat SQL-nya bisa dilihat dan diubah",
  "custom_query": "Kueri khusus",
  "custom_query_tip": "Kueri khusus memungkinkanmu menulis pernyataan kueri sendiri dengan sintaks SQL",
  ...
  "query": {
    ...
    "sql_format": {
      ...
      "table_tip": "Bisa dipakai membuat aturan alert dan aturan perekaman Doris, serta metrik Polaris."
    },
