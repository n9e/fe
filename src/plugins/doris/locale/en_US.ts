const en_US = {
  ...
  query: {
    ...
    sql_format: {
      ...
      origin_tip: 'For Log Explorer - Raw mode',
      timeseries: 'View Time Series',
      timeseries_tip: 'For Log Explorer - Time Series mode, or for drawing time series charts based on Doris data in dashboards',
      table: 'View Statistics',
      table_tip: 'Used for creating Doris alerting rules, recording rules, creating Polaris indicators, etc.',
    },
