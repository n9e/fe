const en_US = {
  ...
  quick_query_tip:
    'Quick query: quickly generate query statements from a fixed SQL template. For example, if field A is greater than 0, simply enter A>0. Click this button to switch to custom mode where you can view and modify the SQL statement',
  custom_query: 'Custom query',
  custom_query_tip: 'Custom queries let you freely write query statements in SQL',
  ...
  query: {
    ...
    sql_format: {
      ...
      table_tip: 'Can be used to create Doris alert rules, recording rules, and Polaris metrics.',
    },
    ...
    datasource_disabled_tip: 'Please select a data source first',
    interval: 'Interval',
    interval_tip:
