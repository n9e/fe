...
export default function SQLBuilder(props: Props) {
  ...
  const openAdvancedVariableFormatsDoc = () => {
    DocumentDrawer({
      language: i18n.language === 'zh_CN' ? 'zh_CN' : 'en_US',
      darkMode,
      title: t('query.advanced_variable_formats'),
      documentPath: '/n9e-docs/dashboards/variables/advanced-variable-formats',
    });
  };
  const openQueryConditionDoc = () => {
    DocumentDrawer({
      language: i18n.language === 'zh_CN' ? 'zh_CN' : 'en_US',
      darkMode,
            ...
            <Tooltip
              ...
              title={
                <Trans
                  ...
                  components={{
                    1: <br />,
                    a: <a onClick={openQueryConditionDoc} />,
                    advanced: <a onClick={openAdvancedVariableFormatsDoc} />,
                  }}
                />
              }
            >
              <InfoCircleOutlined onClick={openQueryConditionDoc} />
            </Tooltip>
          </Space>
        }
        {...restField}
