...
import { NAME_SPACE } from '@/plugins/pgsql/constants';
          ...
          {mode === 'graph' && (
            <>
              <Col span={span}>
                ...
                >
                  <Form.Item {...restPrefixField} name={[...prefixName, 'keys', 'valueKey']} style={{ width: '100%' }}>
                    <Select
                      mode='tags'
                      disabled={disabled}
              ...
              {showUnit && (
                <Col span={span}>
                  <InputGroupWithFormItem label={t('common:unit')}>
                    <Form.Item {...restPrefixField} name={[prefixField.name, 'unit']} initialValue='none'>
