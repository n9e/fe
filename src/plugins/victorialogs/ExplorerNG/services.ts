...
export function getStreamFields(data: { cate: DatasourceCateEnum; datasource_id: number; query: string; start: number; end: number; filter?: string }): Promise<string[]> {
