const ru_RU = {
  ...
  onboarding: {
    ...
    viewFull: 'Открыть полное руководство',
  ...
  quickStart: {
    ...
    ingest: {
      ...
      links: ['Как развернуть коллектор Categraf?', 'Как собирать данные хостов через Categraf?'],
    },
    observe: {
    ...
    ai: {
      ...
      links: ['Какие встроенные навыки есть у Nightingale?', 'Как использовать агентов для анализа алертов?'],
    },
  },
  aiAssistant: {
