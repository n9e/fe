    ...
    >
      ...
      {modalType === 'ImportGrafanaURL' ? (
        ...
        >
          ...
          <Form.Item label={t('settings.hideHeader.label')} name='hideHeader' valuePropName='checked' initialValue={false} tooltip={t('settings.hideHeader.tip')}>
            <Switch />
          </Form.Item>
