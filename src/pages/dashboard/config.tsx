...
export const AddPanelIcon = (props: React.ComponentProps<typeof Icon>) => <Icon component={AddPanelSvg} {...props} className='anticon-addpanel' />;
export { DASHBOARD_VERSION } from './constants';
