const pt_BR = {
  ...
  batch: {
    ...
    import_grafana_tip:
      'Apenas dashboards com fontes de dados Prometheus e com os tipos de gráfico e recursos suportados pelo Nightingale podem ser importados <a>Relatar um problema</a>',
    ...
    show_time_picker: 'Exibir seletor de tempo',
    show_time_picker_tip: 'Algumas versões do Grafana ocultam o seletor de tempo no modo quiosque. Ative esta opção para usar o seletor de tempo deste sistema.',
  ...
  var: {
    ...
    reg_object_tip:
      'Para opções com nome de exibição separado, a expressão regular verifica o valor. Correspondências comuns preservam ambos os campos; grupos text/value substituem apenas o campo correspondente.',
    ...
    custom: {
      ...
      table: {
        ...
        tableLayout: {
          ...
          label_tip:
            'No layout fixo as colunas dividem a largura igualmente e não há rolagem horizontal. No layout automático cada coluna tem no máximo 150px, e o conteúdo pode transbordar, gerando rolagem horizontal.',
          auto: 'Automático',
          fixed: 'Fixo',
        },
      ...
      tableNG: {
        ...
        enableRowDetail_tip:
          'Quando ativado, a primeira coluna exibe um ícone de detalhes. Ao clicar nele, um painel lateral mostra todos os campos e valores da linha, com opção de copiar a linha inteira ou campos isolados.',
        rowDetail: {
        ...
        cellOptions: {
          ...
          wrapText_tip:
            'Quando ativado, o texto da célula quebra automaticamente e a altura da linha se ajusta ao número de linhas de texto; com muitos dados isso afeta o desempenho',
          'color-background': {
            mode: {
              label: 'Modo de cor',
              options: {
  ...
  migrate: {
    ...
    desc_1:
      'A versão v6 deixa de suportar a troca global de cluster Prometheus; nas versões novas, associe os gráficos a uma variável de fonte de dados para obter o mesmo efeito.',
...
__variable_value_fixed=true: preservar os valores das variáveis da URL sem substituí-los pelo armazenamento local ou padrões das opções.`,
  ...
  settings: {
    ...
    hideHeader: {
      label: 'Ocultar título do dashboard',
      tip: 'Quando ativado, oculta apenas o título no topo da página de detalhes do dashboard.',
    },
