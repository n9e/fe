const id_ID = {
  ...
  sharing_link: {
    ...
    revoked: 'Dicabut',
    anonymous_tip:
      'Selama masa berlakunya, tautan anonim memungkinkan siapa pun melihat dasbor ini tanpa masuk dan mengueri data dari sumber data yang dirujuknya, jadi bagikan dengan hati-hati',
    recommend_tip:
      'Akses anonim berjalan lewat tautan di bawah: selama masa berlakunya, dasbor bisa dibuka tanpa masuk. Untuk akses publik jangka panjang, setel masa berlaku ke satuan tahun',
    unit_hour: 'Jam',
    unit_day: 'Hari',
    unit_month: 'Bulan',
    unit_year: 'Tahun',
    ...
    revoke_all_confirm_content:
      'Dasbor ini masih punya {{num}} tautan berbagi anonim yang berlaku. Keberlakuan tautan tidak bergantung pada pengaturan visibilitas, jadi setelah jenisnya diubah pun tautan itu tetap membuka dasbor ini tanpa perlu masuk. Melanjutkan akan mencabut semua tautan berbagi dasbor ini dan menyimpan pengaturannya; pencabutan tidak bisa dibatalkan.',
    revoke_all_ok: 'Cabut lalu simpan',
    revoke_all_check_failed:
      'Tidak dapat memastikan apakah dasbor ini masih punya tautan berbagi anonim. Pengaturan visibilitas sudah disimpan; buka dialog tautan berbagi untuk memeriksanya secara manual',
  },
  default_filter: {
    title: 'Filter bawaan',
  ...
  batch: {
    ...
    show_time_picker: 'Tampilkan pemilih waktu',
    show_time_picker_tip: 'Beberapa versi Grafana menyembunyikan pemilih waktu dalam mode kios. Aktifkan opsi ini untuk menggunakan pemilih waktu di sistem ini.',
    ...
    custom: {
      ...
      table: {
        ...
        tableLayout: {
          ...
          label_tip:
            'Pada tata letak tetap, lebar kolom dibagi rata sesuai jumlah kolom sehingga tidak muncul gulir horizontal. Pada tata letak otomatis, lebar maksimum kolom adalah 150px sehingga isinya bisa meluap dan memunculkan gulir horizontal.',
          auto: 'Otomatis',
          fixed: 'Tetap',
        },
      ...
      tableNG: {
        ...
        enableRowDetail_tip:
          'Bila diaktifkan, kolom pertama tabel menampilkan ikon detail. Mengekliknya membuka panel geser di kanan yang memuat seluruh field dan nilai baris itu, lengkap dengan opsi menyalin satu baris atau satu field.',
        rowDetail: {
  ...
  query: {
    ...
    expression_placeholder:
      'Lakukan operasi matematika atas satu kueri atau lebih. Rujuk kueri lewat ${refId}, yaitu $A, $B, $C, dan seterusnya. Contoh penjumlahan dua skalar: $A + $B > 10',
