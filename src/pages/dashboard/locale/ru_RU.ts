const ru_RU = {
  ...
  sharing_link: {
    ...
    recommend_tip: 'Публичный анонимный дашборд постоянно доступен всем, у кого есть URL. Для временного доступа создайте ограниченную по времени ссылку через «Создать ссылку для общего доступа»',
  },
  default_filter: {
    title: 'Фильтр',
    public: 'Общие панели',
