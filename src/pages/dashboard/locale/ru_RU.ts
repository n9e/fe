const ru_RU = {
  ...
  copyPanelTip: 'Конфигурация панели скопирована. Нажмите "Добавить диаграмму" > "Импорт конфигурации диаграммы", чтобы вставить JSON конфигурацию и создать диаграмму',
  batch: {
