const en_US = {
  ...
  log: {
    ...
    log_download: {
      ...
      organize_fields_placeholder: 'All fields by default',
    ...
    log_export: {
      ...
      status3: 'Canceled',
      status4: 'Generated with warnings',
      datasource: 'Data source',
      current_datasource: 'Current data source',
      ...
      cancel_btn: 'Cancel',
      cancel_btn_tips: 'Cancel this download task?',
