const ru_RU = {
  ...
  log: {
    ...
    log_download: {
      ...
      organize_fields_placeholder: 'Все поля по умолчанию',
      createSuccess: 'Задача создана успешно',
    },
    log_export: {
      status_doing: 'Экспортируется',
      status_done: 'Завершено',
      status3: 'Отменено',
      status4: 'Создано с предупреждениями',
      datasource: 'Источник данных',
      current_datasource: 'Текущий источник',
      all_datasources: 'Все источники',
      creator: 'Создатель',
      all_users: 'Все пользователи',
      task_status: 'Статус задачи',
      all_statuses: 'Все статусы',
      cancel_btn: 'Отменить',
      cancel_btn_tips: 'Отменить эту задачу скачивания?',
