const ru_RU = {
  ...
  home_page_url: 'URL доступа по умолчанию',
  home_page_url_tip: 'При переходе на корневой путь / выполняется перенаправление на заданный адрес. По умолчанию: /landing',
  displayMode: {
    tree: 'Дерево',
    list: 'Список',
  },
