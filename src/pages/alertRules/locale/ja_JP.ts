const ja_JP = {
  ...
  empty_guide: {
    ...
    steps_intro: '3ステップで最初のアラートを動かします：',
    step_datasource: 'データソースを選択：どのデータソースを監視するかを決めます',
    step_rule: 'クエリとアラート条件を設定：クエリを書いてしきい値を設定するか、テンプレートからワンクリックでインポートします',
    step_notify: '通知先を設定：通知ルールまたは受信グループを選択しないと、アラート発生時に誰にも通知されません',
    doc: 'ドキュメントを見る',
  ...
  status_normal: '正常',
  filter_event_status_placeholder: 'アラート状態',
  clone_suffix: '-コピー',
  notify_targets_empty_warning: '通知先が設定されていないため、アラートが発生しても通知は送信されません',
  ...
  form_ng: {
    cate: 'データソースタイプ',
    save_and_back: '保存して戻る',
    section_summary: {
      separator: '、',
      unnamed: '名称未設定',
      tags_count: '追加タグ {{count}} 件',
      datasource_all: 'すべてのデータソース',
      datasource_count: 'データソース {{count}} 件',
      queries_count: 'クエリ {{count}} 件',
      triggers_count: '判定条件 {{count}} 件',
      rule_empty: 'クエリと判定条件が未設定',
      notify_targets_none: '通知先が未設定のため、アラート発生時に通知されません',
      notify_flashduty: 'グローバルイベントプッシュ設定済み',
      effective_disabled: '無効',
      effective_all_time: '毎日終日有効',
      effective_windows: '有効時間帯 {{count}} 件',
      pipeline_workflows: 'ワークフロー {{count}} 件',
      pipeline_none: 'イベント処理未設定',
    },
    prompt: {
