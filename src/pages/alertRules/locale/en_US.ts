const en_US = {
  ...
  form_ng: {
    ...
    test_fire: {
      ...
      sample: 'Sample data',
      sample_real: 'Real series',
      sample_mock: 'Built-in mock',
      sample_mock_only: 'Real series selection is not supported for this datasource type yet, a built-in mock value will be used',
