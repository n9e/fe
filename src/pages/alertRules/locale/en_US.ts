const en_US = {
  ...
  empty_guide: {
    ...
    steps_intro: 'Three steps to get your first alert working:',
    step_datasource: 'Choose a data source: decide which data source to monitor',
    step_rule: 'Configure query and trigger conditions: write the query and set thresholds, or import from templates in one click',
    step_notify: 'Configure notification targets: pick notification rules or receiver groups, otherwise nobody will be notified when the alert fires',
  ...
  filter_event_status_placeholder: 'Alert status',
  clone_suffix: '-copy',
  notify_targets_empty_warning: 'No notification target is configured. No one will be notified when this rule fires',
  ...
  form_ng: {
    ...
    section_summary: {
      separator: ', ',
      unnamed: 'Unnamed',
      tags_count: '{{count}} appended tags',
      datasource_all: 'All data sources',
      datasource_count: '{{count}} data sources',
      queries_count: '{{count}} queries',
      triggers_count: '{{count}} trigger conditions',
      rule_empty: 'No query or trigger conditions configured',
      notify_targets_none: 'No notification target, no one will be notified when the alert fires',
      notify_flashduty: 'Global event push configured',
      effective_disabled: 'Disabled',
      effective_all_time: 'Active all day, every day',
      effective_windows: '{{count}} active time windows',
      pipeline_workflows: '{{count}} workflows',
      pipeline_none: 'No event processing configured',
    },
    prompt: {
