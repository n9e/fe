const en_US = {
  ...
  form_ng: {
    ...
    test_fire: {
      ...
      sample_datasource: 'Select datasource',
      ...
      desc: {
        ...
        query_only_first: 'Multiple datasources matched ({{ids}}), only the first was checked; real alerting evaluates each datasource separately',
