const en_US = {
  ...
  eval_records: {
    ...
    tip: 'Raw data and judge results of each evaluation cycle, stored on the local disk of the alert engine, kept for 8 days by default',
    time: 'Eval time',
    duration: 'Duration',
    ...
    detail_anomalies: 'Judge results',
