const zh_HK = {
  ...
  eval_records: {
    btn: '執行記錄',
    title: '評估執行記錄',
    tip: '每個評估週期查到的原始數據與判定結果，存儲在告警引擎本地磁盤，默認保留 8 天',
    time: '評估時間',
    duration: '耗時',
    datasource: '數據源',
    queries: '查詢結果',
    ...
    funnel: '事件處理',
    funnel_fired: '觸發',
    funnel_pending: '等待持續時長',
    funnel_muted: '屏蔽',
    funnel_dropped: '流水線丟棄',
    funnel_inhibited: '抑制',
    series_total: '{{count}} 條曲線',
    no_series: '無數據',
    query_error: '查詢錯誤',
    detail_query: '查詢現場',
    detail_anomalies: '判定結果',
    detail_events: '事件處理明細',
    event_hash: '事件',
    event_hash_tip: '點擊查看該事件入隊之後的通知處理日誌（受引擎日誌保留時長限制）',
    stage: '階段',
    stage_detail: '裁決說明',
    stage_fired: '已觸發',
    stage_stalled: '重複靜默',
    stage_notify_muted: '通知屏蔽',
    stage_pending: '等待持續時長',
    stage_muted: '已屏蔽',
    stage_muted_notify_only: '僅屏蔽通知',
    stage_muted_by_hook: '被 hook 屏蔽',
    stage_drop_by_pipeline: '流水線丟棄',
    stage_inhibited: '被抑制',
    stage_recovered: '已恢復',
    stage_push_queue_failed: '入隊失敗',
    labels: '標籤',
    value: '值',
    point_time: '數據時間',
    recover: '恢復',
    truncated: '內容超出容量上限，原始曲線已部分截斷',
    var_query: '變量展開查詢',
    empty: '該時間範圍內沒有執行記錄。\n記錄存儲在告警引擎本地磁盤，默認保留 8 天；舊版本引擎或未開啟 EvalLog 時無記錄。',
    load_more: '加載更早的記錄',
    node_error_title: '部分告警引擎節點查詢失敗，以下節點的記錄未包含在結果中',
    node_error_hint: '記錄仍保存在對應引擎節點（如 edge 機房）的本地磁盤上。可登錄該節點，在本機執行以下命令查看（認證賬號為該節點 HTTP.APIForService 配置的 BasicAuth）：',
  },
  prod: '監控類型',
  severity: '級別',
  notify_groups: '告警接收組',
