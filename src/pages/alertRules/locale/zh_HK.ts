const zh_HK = {
  ...
  empty_guide: {
    title: '還沒有告警規則',
    steps_intro: '三步跑通第一條告警：',
    step_datasource: '選擇數據源：確定要監控哪個數據源的數據',
    step_rule: '配置查詢與告警條件：編寫查詢語句並設置閾值，也可以從模板一鍵導入',
    step_notify: '配置通知目標：選擇通知規則或接收組，否則告警觸發後不會有人收到通知',
    doc: '查看使用文檔',
  ...
  status_normal: '無告警',
  filter_event_status_placeholder: '告警狀態',
  clone_suffix: '-副本',
  notify_targets_empty_warning: '當前未配置任何通知目標，告警觸發後將不會發送通知',
  ...
  form_ng: {
    ...
    section_summary: {
      separator: '、',
      unnamed: '未命名',
      tags_count: '{{count}} 個附加標籤',
      datasource_all: '全部數據源',
      datasource_count: '{{count}} 個數據源',
      queries_count: '{{count}} 條查詢',
      triggers_count: '{{count}} 個判定條件',
      rule_empty: '未配置查詢與判定條件',
      notify_targets_none: '未配置通知目標，告警觸發後不會發送通知',
      notify_flashduty: '已配置全局事件推送',
      effective_disabled: '未啟用',
      effective_all_time: '每天全天生效',
      effective_windows: '{{count}} 個生效時間段',
      pipeline_workflows: '{{count}} 個工作流',
      pipeline_none: '未配置事件處理',
    },
    prompt: {
      title: '有更改未儲存',
      message: '您想儲存變更嗎？',
