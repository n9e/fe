const zh_HK = {
  ...
  pipeline_configuration_ng: {
    ...
    enabled: '啟用',
    save_workflow: '保存工作流',
    save_workflow_modal_title_new: '保存為新工作流',
    save_workflow_modal_title_edit: '編輯工作流',
    workflow_name: '工作流名稱',
    workflow_name_placeholder: '請輸入工作流名稱',
    workflow_name_required: '工作流名稱不能為空',
    workflow_unsaved: '工作流配置未保存',
    legacy_multi_workflow_tip: '舊版本配置，建議只保留一個工作流',
    save_workflow_failed: '保存工作流失敗',
    reference_workflow_tip: '已引用工作流「{{workflowName}}」修改下方處理器後，所有引用該工作流的規則將同步生效。',
    no_changes: '處理器配置沒有變化',
    save_workflow_tip: '點擊保存工作流後，才會真正生成或修改事件處理工作流',
  },
};
