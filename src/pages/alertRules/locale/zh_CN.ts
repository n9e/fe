const zh_CN = {
  ...
  pipeline_configuration_ng: {
    ...
    enabled: '启用',
    save_workflow: '保存工作流',
    save_workflow_modal_title_new: '保存为新工作流',
    save_workflow_modal_title_edit: '编辑工作流',
    workflow_name: '工作流名称',
    workflow_name_placeholder: '请输入工作流名称',
    workflow_name_required: '工作流名称不能为空',
    workflow_unsaved: '工作流配置未保存',
    legacy_multi_workflow_tip: '旧版本配置，建议只保留一个工作流',
    save_workflow_failed: '保存工作流失败',
    reference_workflow_tip: '已引用工作流「{{workflowName}}」修改下方处理器后，所有引用该工作流的规则将同步生效。',
    no_changes: '处理器配置没有变化',
    save_workflow_tip: '点击保存工作流后，才会真正生成或修改事件处理工作流',
  },
};
