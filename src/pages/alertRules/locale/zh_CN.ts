const zh_CN = {
  ...
  empty_guide: {
    title: '还没有告警规则',
    steps_intro: '三步跑通第一条告警：',
    step_datasource: '选择数据源：确定要监控哪个数据源的数据',
    step_rule: '配置查询与告警条件：编写查询语句并设置阈值，也可以从模板一键导入',
    step_notify: '配置通知目标：选择通知规则或接收组，否则告警触发后不会有人收到通知',
    doc: '查看使用文档',
    from_template: '从模板导入',
  },
  ...
  status_normal: '无告警',
  filter_event_status_placeholder: '告警状态',
  clone_suffix: '-副本',
  notify_targets_empty_warning: '当前未配置任何通知目标，告警触发后将不会发送通知',
  ...
  form_ng: {
    ...
    section_summary: {
      separator: '、',
      unnamed: '未命名',
      tags_count: '{{count}} 个附加标签',
      datasource_all: '全部数据源',
      datasource_count: '{{count}} 个数据源',
      queries_count: '{{count}} 条查询',
      triggers_count: '{{count}} 个判定条件',
      rule_empty: '未配置查询与判定条件',
      notify_targets_none: '未配置通知目标，告警触发后不会发送通知',
      notify_flashduty: '已配置全局事件推送',
      effective_disabled: '未启用',
      effective_all_time: '每天全天生效',
      effective_windows: '{{count}} 个生效时间段',
      pipeline_workflows: '{{count}} 个工作流',
      pipeline_none: '未配置事件处理',
    },
    prompt: {
      title: '有更改未保存',
      message: '您想保存更改吗？',
