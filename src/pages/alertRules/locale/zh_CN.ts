const zh_CN = {
  ...
  form_ng: {
    ...
    test_fire: {
      ...
      sample_real: '真实序列',
      sample_mock: '内置模拟值',
      sample_mock_only: '当前数据源类型暂不支持选择真实序列，将使用内置模拟值合成事件',
      ...
      desc: {
        ...
        subscribe_none: '未命中订阅规则',
        subscribe_matched: '将同时命中订阅规则：{{names}}（测试不触发订阅通知）',
        side_effects: '测试模式已跳过：回调 {{callbacks}} 个、自愈任务 {{taskTpls}} 个',
      },
    },
  },
};
