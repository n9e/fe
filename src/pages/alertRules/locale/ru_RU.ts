const ru_RU = {
  ...
  form_ng: {
    ...
    test_fire: {
      ...
      sample_real: 'Реальная серия',
      sample_mock: 'Встроенное мок-значение',
      sample_mock_only: 'Для этого типа источника данных выбор реальной серии пока не поддерживается, будет использовано встроенное мок-значение',
      ...
      stages: {
        ...
        subscribe: 'Совпадение подписок',
        side_effects: 'Колбэки и самовосстановление',
      },
      status: {
        pass: 'Пройдено',
        warn: 'Внимание',
      ...
      desc: {
        ...
        mute_matched: 'Реальное событие было бы заблокировано правилами подавления: {{names}} (тест продолжается)',
        ...
        subscribe_none: 'Ни одна подписка не совпала',
        subscribe_matched: 'Также совпадут подписки: {{names}} (в тестовом режиме подписки не срабатывают)',
        side_effects: 'Пропущено в тестовом режиме: колбэков {{callbacks}}, задач самовосстановления {{taskTpls}}',
      },
    },
  },
