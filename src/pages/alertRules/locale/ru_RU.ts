const ru_RU = {
  ...
  empty_guide: {
    ...
    steps_intro: 'Три шага, чтобы запустить первое оповещение:',
    step_datasource: 'Выберите источник данных: определите, какой источник данных мониторить',
    step_rule: 'Настройте запрос и условия срабатывания: напишите запрос и задайте пороги, либо импортируйте из шаблонов в один клик',
    step_notify: 'Настройте цели уведомлений: выберите правила уведомлений или группы получателей, иначе при срабатывании оповещения никто его не получит',
  ...
  filter_event_status_placeholder: 'Статус оповещения',
  clone_suffix: '-копия',
  notify_targets_empty_warning: 'Цели уведомлений не настроены. При срабатывании правила никто не получит уведомление',
  ...
  form_ng: {
    ...
    section_summary: {
      ...
      tags_count: 'Доп. теги: {{count}}',
      datasource_all: 'Все источники данных',
      datasource_count: 'Источники данных: {{count}}',
      queries_count: 'Запросы: {{count}}',
      triggers_count: 'Условия срабатывания: {{count}}',
      rule_empty: 'Запрос и условия срабатывания не настроены',
      notify_targets_none: 'Цели уведомлений не настроены, уведомления не будут отправлены',
      notify_flashduty: 'Настроен глобальный push событий',
      effective_disabled: 'Отключено',
      effective_all_time: 'Действует круглосуточно каждый день',
      effective_windows: 'Окна действия: {{count}}',
      pipeline_workflows: 'Рабочие процессы: {{count}}',
      pipeline_none: 'Обработка событий не настроена',
    },
    prompt: {
