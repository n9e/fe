const ru_RU = {
  ...
  name_severities_appendtags: 'Название и уровень и дополнительные теги',
  append_tags: 'Дополнительные теги',
  ...
  enable_in_bg_tip:
    'Определяется по принадлежности ident в событии оповещения. То есть, если в событии оповещения есть тег ident, но машина, соответствующая этому ident, не принадлежит этой бизнес-группе, это событие оповещения будет отброшено',
  ...
  batch: {
    ...
    cloneToHosts: {
      title: 'Клонировать на несколько хостов',
      select_hosts: {
        title: 'Выбрать хосты',
        filter: 'Фильтр',
