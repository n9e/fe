const ru_RU = {
  ...
  relabel: {
    ...
    deprecation_warning: 'Event Relabel скоро будет удален. Обнаружена историческая конфигурация Relabel в текущем правиле. Рекомендуется использовать процессор «Перезапись меток событий» в «Рабочем процессе обработки событий» выше для достижения эквивалентной функциональности.',
