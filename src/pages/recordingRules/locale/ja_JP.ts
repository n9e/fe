const ja_JP = {
  ...
  name_msg: "指標名が無効です",
  name_tip:
    "promqlの周期的な計算によって、新しい指標が生成されます。この新しい指標の名前をここに入力してください",
  note: "備考",
  disabled: "有効",
  cron_pattern: "実行頻度",
  cron_pattern_msg: "Cron式を入力してください",
  cron_pattern_tip:
    "Cron式、秒から日までサポートしています。例えば、1 * * * * * は毎分の最初の秒に実行します。簡略化して @every 60s とも書けます",
  append_tags: "追加タグ",
  ...
  append_tags_placeholder:
    "タグの形式は key=value です。改行または空白で区切ってください",
  batch: {
