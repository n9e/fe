const ko_KR = {
  ...
  "redefine_channels": "알림 매체 다시 지정",
  "redefine_webhooks": "콜백 주소 다시 지정",
  "user_group_ids": "구독할 알림 수신 그룹",
  "for_duration": "이벤트 지속 시간이 다음을 넘을 때 구독 (초)",
  "for_duration_tip": "예를 들어 300으로 설정했다면, 같은 알림 이벤트가 처음 구독에 걸릴 때는 조건에 맞지 않습니다. 이후 다시 걸릴 때 그 시점의 발생 시각과 처음 걸렸을 때의 발생 시각 차이를 계산해, 300초를 넘으면 구독 조건을 만족해 알림 로직을 타고, 300초보다 작으면 구독에 걸리지 않습니다. 이 기능은 알림 에스컬레이션으로도 쓸 수 있습니다. 팀 책임자가 지속 시간 1시간(3600초)이 넘는 구독을 만들고 수신자를 자기 자신으로 두면, 최종 책임자로서 모든 알림에 누군가는 반드시 대응하도록 보장할 수 있습니다.",
  "webhooks": "새 콜백 주소",
  ...
  "notify_configs_desc": "걸린 알림 이벤트를 아래 알림 전송 규칙으로 한 번 더 알립니다. 알림을 올리거나 다른 팀에 넘길 때 흔히 씁니다",
  ...
  "notify_rule_ids_msg": "알림 전송 규칙을 최소 하나는 고르세요. 그렇지 않으면 구독에 걸린 이벤트가 전송되지 않습니다",
  "name_auto": {
    "tip": "이름은 위의 필터와 알림 설정을 바탕으로 자동으로 만들어지며 언제든 직접 고칠 수 있습니다",
    "all": "모든 알림",
    "escalation": "에스컬레이션",
    "separator": "、",
    "joiner": "-",
  ...
  "section_summary": {
    ...
    "no_extra": "그 밖의 조건 없음",
    "notify_rules_none": "알림 전송 규칙을 고르지 않았습니다",
  ...
  "scenario_tips": {
    ...
    "escalation": "에스컬레이션 안전망: 1시간 동안 복구되지 않은 알림을 팀 책임자에게 한 번 더 알리기",
