 ...
 */
export const CATEGRAF_TROUBLESHOOT_DOC = IS_ENT
  ? '/docs/content/flashcat/metric/explore/'
  : 'https://flashcat.cloud/docs/content/flashcat-monitor/nightingale-v9/quickstart/ad-hoc/';
