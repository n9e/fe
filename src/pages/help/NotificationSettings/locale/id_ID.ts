const id_ID = {
  ...
  "webhooks": {
    "help_content": "Callback menghubungkan Nightingale dengan sistem lain. Setiap event alert yang dihasilkan Nightingale dikirim ke tiap URL callback, jadi kamu bisa membuat API HTTP sendiri, mendaftarkannya di sini, menerima event alert Nightingale, lalu menjalankan logika otomatis atau khusus di atasnya. Nightingale memanggilnya dengan metode HTTP POST dan menaruh isi event dalam format JSON di body permintaan; struktur datanya bisa dilihat [di sini](https://github.com/ccfos/nightingale/blob/main/models/alert_cur_event.go#L19). Untuk mencobanya, siapkan sebuah mesin yang terjangkau jaringan Nightingale, misalnya beralamat IP 10.1.2.3, lalu buka sebuah porta dengan nc, misalnya `nc -k -l 4321` agar nc mendengarkan di porta 4321. Daftarkan `http://10.1.2.3:4321` sebagai URL callback, buat satu aturan alert, dan begitu alert terpicu Nightingale akan memanggil alamat itu sehingga format data lengkapnya terlihat pada keluaran perintah nc.",
    "title": "URL callback",
    "enable": "Aktifkan",
    "note": "Catatan",
    "url": "URL",
