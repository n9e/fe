const ja_JP = {
  ...
  form: {
    ...
    es: {
      ...
      version: 'バージョン',
      version_placeholder: '空白のままにすると自動的にバージョンを取得します。特別な要件がない場合は空白のままにしてください。指定する必要がある場合は、x.y.z 形式で記入してください（例：7.10.2）',
      version_tip: '空白のままにすると自動的にバージョンを取得します。特別な要件がない場合は空白のままにしてください。指定する必要がある場合は、x.y.z 形式で記入してください（例：7.10.2）',
