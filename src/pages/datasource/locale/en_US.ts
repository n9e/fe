const en_US = {
  ...
  auth: {
    ...
    project:'Project',
    logstore:'Logstore',
    delMessage:"Are you sure you want to delete this auth?",
    updatetime:"Update time",
    owner: "Creator",
    alluser: "All users",
    allusergroup: "All user groups",
    alllbusiness: "All business groups",
    inputplaceholder: "Multiple inputs are supported, separated by commas",
    assignplaceholder:"Please select the user, team, and business group to be granted"
  },
  form: {
    other: 'Other',
    name: 'Name',
