const ja_JP = {
  ...
  all_targets: '全てのマシン',
  datasource: 'データソース',
  search_placeholder: 'テーブルの内容を模糊検索（複数のキーワードはスペースで区切ってください）',
  filterDowntime: '心拍更新',
  filterDowntimeNegative: '心拍が更新されました',
  filterDowntimePositive: '心拍が更新されていません',
  filterDowntimeNegativeMin: '{{count}} 分間更新',
  filterDowntimePositiveMin: '{{count}} 分間更新されていません',
  ...
  update_at_tip: '\n    1分以内に心拍があれば：緑色 <1 />\n    3分以内に心拍があれば：黄色 <1 />\n    3分以内に心拍がなければ：赤色\n  ',
  remote_addr: 'リモートIP',
  remote_addr_tip: 'リモートIPはHTTPヘッダから取得されますが、プロキシを経由した場合は、実際のリモートIPとは異なる場合があります',
  ...
  bind_tag: {
    ...
    render_tip2: 'タグの形式は key=value です。key はアルファベットまたはアンダースコアで始まり、アルファベット、数字、アンダースコアで構成されます。',
  },
  unbind_tag: {
    title: 'タグのバインド解除',
