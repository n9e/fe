const ja_JP = {
  ...
  user: {
    ...
    disable_action: '無効化',
    enable_action: '有効化',
    disable_confirm: 'ユーザー {{username}} を無効化しますか？無効化するとログインできなくなりますが、権限設定は保持されます',
    enable_confirm: 'ユーザー {{username}} を有効化しますか？',
    disable_success: 'ユーザーを無効化しました',
    enable_success: 'ユーザーを有効化しました',
