const es_ES = {
  ...
  "tab_instructions": "Sobre la recolección",
  ...
  "readme": "Sobre la recolección",
  "componentFormModal": {
    "edit": "Editar plantilla",
    "create": "Crear plantilla"
  },
  "logo_picker_title": "Seleccionar icono",
  "logo_picker_title_placeholder": "Admite base64 o una URL",
  "name": "Nombre",
  "payload_name": "Nombre de la plantilla",
  "tags": "Etiquetas",
  "variable": "Variable",
  ...
  "content": "Contenido",
  "format": "Formatear",
  "format_failed": "Error al formatear; comprueba que el contenido sea un JSON válido",
  "formModal": {
    "edit": {
  ...
  "payloads": "Plantilla",
  "tags_placeholder": "Separa con Intro o espacio",
  "collect_create": "Crear recolección",
  "collect_busiGroup_select": "Selección de grupo de negocio",
  "import_to_buisGroup": "Grupo de negocio de destino",
  "import_to_buisGroup_invaild": "No se pueden importar reglas de alerta de un tipo de origen de datos distinto",
  "payload_by_system": "Integrado en el sistema",
  "firemap": {
  ...
  "pack": {
    "title": "Integración en tres pasos",
    "progress": "{{done}}/{{total}}",
    "steps": {
