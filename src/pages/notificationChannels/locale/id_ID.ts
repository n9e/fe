const id_ID = {
  ...
  "smtp_request_config": {
    ...
    "port": "Porta",
    "port_tip": "Nomor porta server SMTP. Yang umum adalah 25, 465 (SSL), dan 587 (STARTTLS); pastikan portanya ke penyedia layananmu",
  ...
  "test": {
    ...
    "pagerduty_keys_tip": "PagerDuty mengirim berdasarkan integration key. Setelah disimpan, kamu bisa memilihnya lewat Layanan/integrasi di aturan notifikasi; untuk sekarang isikan sendiri di sini, boleh lebih dari satu.",
