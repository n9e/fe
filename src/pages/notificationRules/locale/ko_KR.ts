const ko_KR = {
  "title": "통지 규칙",
  "empty_guide": {
    "title": "아직 통지 규칙이 없습니다",
    "desc": "통지 규칙은 알림을 누구에게 어떤 매체로 보낼지 정합니다. 이 규칙이 있어야 알림 이벤트가 DingTalk나 이메일 같은 채널로 실제로 전달됩니다.",
    "config_channel": "먼저 통지 매체를 설정하세요"
  },
  "rule_select": {
    "label": "통지 규칙",
    "select": "통지 규칙 선택",
    ...
    "quick_create": {
      ...
      "reused_rule": "같은 토큰을 쓰는 통지 규칙이 이미 있어 자동으로 선택했습니다",
      "created": "통지 규칙을 만들고 선택했습니다",
      "create_channel_no_perm": "{{channel}} 통지 매체가 없고 지금 사용자에게는 만들 권한이 없습니다. 관리자에게 먼저 만들어 달라고 요청하세요",
      "create_channel_failed": "통지 매체를 만들지 못했습니다: {{channel}}",
      "create_rule_failed": "통지 규칙을 만들지 못했습니다",
  ...
  "basic_configuration_desc": "통지 규칙의 이름, 권한을 가진 팀, 메모",
  "name_auto_tip": "통지 매체와 수신 팀을 고르면 이름이 자동으로 만들어지며 언제든 고칠 수 있습니다",
  "name_auto_separator": ", ",
  "add_note_btn": "메모 추가",
  "user_group_ids": "권한을 가진 팀",
  "user_group_ids_tip": "여기 적은 팀의 사용자가 이 통지 규칙을 관리하거나 볼 수 있습니다",
  ...
  "notification_configuration": {
    ...
    "filters": {
      "title": "필터 조건",
      "tip": "이 통지 설정이 조건에 맞는 알림 이벤트에만 적용되도록 제한합니다. 등급, 시간대, 레이블, 속성이 그 조건이며 비워 두면 제한하지 않습니다",
    ...
    "mock_test": {
      "empty_alert": "이 환경에는 아직 알림 이벤트가 없습니다. 시뮬레이션 이벤트로 통지 채널을 바로 테스트할 수 있습니다",
      "switch_btn": "시뮬레이션 이벤트 사용하기",
      "desc": "이 통지 설정의 매체와 수신 대상에게 내장 시뮬레이션 알림 이벤트를 한 건 보내 채널이 동작하는지 확인합니다. 시뮬레이션 테스트에서는 필터를 검사하지 않습니다",
      "preview_title": "시뮬레이션 이벤트 미리보기",
      "preview_rule_name": "규칙 이름",
      "preview_severity": "알림 등급",
      "preview_tags": "레이블",
      "rule_name": "통지 테스트용 시뮬레이션 이벤트"
    },
    "channel": "통지 매체",
    "channel_tip": "알림 이벤트를 어떤 매체로 보낼지 고릅니다. 기존 매체로 부족하면 관리자에게 새 매체를 만들어 달라고 요청하세요",
    "channel_msg": "통지 매체를 선택하세요",
    "template": "메시지 템플릿",
    "template_tip": "통지 내용의 템플릿이며 상황에 따라 다른 템플릿을 쓸 수 있습니다",
    ...
    "time_ranges": "적용 시간대",
    "time_ranges_tip": "통지 규칙을 특정 시간대에만 적용되도록 제한할 수 있으며 비워 두면 제한하지 않습니다",
    ...
    "label_keys": "적용 레이블",
    "label_keys_tip": "통지 규칙을 이벤트 레이블로 걸러 낸 알림 이벤트에만 적용되도록 제한할 수 있으며 비워 두면 제한하지 않습니다",
    "attributes": "적용 속성",
    "attributes_value": "속성 값",
    "attributes_tip": "통지 규칙을 특정 이벤트 속성에 맞는 알림 이벤트에만 적용되도록 제한할 수 있으며 비워 두면 제한하지 않습니다",
    "attributes_options": {
      "group_name": "비즈니스 그룹",
      "cluster": "데이터 소스",
    ...
    "run_test_btn": "통지 테스트",
    "run_test_btn_tip": "이미 생긴 이벤트를 몇 개 골라 이 통지 설정이 맞는지 확인할 수 있습니다. 설정이 맞다면 통지 메시지가 도착할 것입니다",
    "run_test_request_result": "테스트 통지를 보냈으며 전송 대상의 응답은 다음과 같습니다:",
    "user_info": {
      "user_ids": "수신자",
      "user_group_ids": "수신 팀",
  ...
  "channel_invalid_tip": "통지 매체가 없습니다",
  "disabled": "사용 중지",
  "pipeline_configuration": {
    "title": "이벤트 처리 워크플로",
    "section_desc": "통지를 보내기 전에 이벤트 처리 워크플로가 알림 이벤트를 다듬습니다. 레이블 붙이기, 보강, 잡음 줄이기 같은 일입니다",
  ...
  "escalations": {
    "title": "에스컬레이션 설정",
    "section_desc": "알림이 오래 복구되지 않거나 담당이 정해지지 않으면 지정한 채널로 통지를 올려 아무도 챙기지 않는 일을 막습니다",
    "title_tip": "알림이 정한 시간을 넘도록 복구되지 않으면 아래 조건에 따라 지정한 채널로 통지를 올려 오래 방치되지 않게 합니다. 자세한 설정은 <a>사용 문서</a>를 보세요",
    "item_title": "통지 에스컬레이션",
    "item_add_btn": "통지 에스컬레이션 추가",
    "interval": "점검 주기",
    "interval_required": "점검 주기는 비워 둘 수 없습니다",
    "duration_required": "지속 시간은 비워 둘 수 없습니다",
    "duration_1": "이상 이벤트가",
    "duration_2": "을(를) 넘었고 여전히",
    "duration_3": "상태일 때 이 설정으로 통지를 보냅니다.",
    "repeating_notification": "반복 통지 설정",
    "repeating_notification_tip": "이 옵션을 끄면 같은 이벤트에 대한 에스컬레이션 통지를 한 번만 보냅니다",
    "repeating_notification_1": "간격",
    "repeating_notification_2": "분마다 한 번씩 알리며 최대",
    "repeating_notification_3": "회",
    "notification_interval_required": "통지 간격은 비워 둘 수 없습니다",
    "notification_max_times_required": "최대 반복 통지 횟수는 비워 둘 수 없습니다",
  ...
  "notify_aggr_configs": {
    "title": "집계 설정",
    "section_desc": "비슷한 알림을 레이블이나 속성 차원으로 묶어 한 건의 통지로 보내 방해를 줄입니다",
    "enable": "집계 켜기",
    "group_enable": "세밀한 집계",
    "group_title": "세밀한 집계",
    "group_add_btn": "세밀한 집계 추가",
    "group_tip1": "다음 조건을 만족하면",
    "group_tip2": "다음 차원으로 묶어 한 건의 통지로 보냅니다",
    ...
    "default_title": "기본 차원",
    "default_tip": "위 필터에 맞지 않으면 <b>다음 차원으로 묶어 한 건의 통지로 보냅니다</b>",
    ...
    "enable_tip": "켜면 조건에 맞는 알림이 차원별로 묶여 한 건의 통지가 됩니다 <a>사용 문서</a>",
    "labels_filter": {
  ...
  "statistics": {
    "total_notify_events": "최근 {{days}}일 통지 횟수",
    "total_notify_events_tip": "실제로 전송된 통지만 셉니다. <b>묶이거나 억제되거나 차단된</b> 이벤트는 포함하지 않습니다",
    ...
    "noise_reduction_ratio_tip": "잡음 감소율 = <b>(1 − 실제 전송한 통지 수 ÷ 원래 알림 이벤트 수) × 100%</b>. <b>100%</b>에 가까울수록 <b>잡음이 잘 줄어든 것</b>입니다"
  },
  "tabs": {
    "events": "이벤트 목록",
    "rules": "알림 규칙",
