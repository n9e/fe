const id_ID = {
  ...
  "rule_select": {
    ...
    "quick_create": {
      ...
      "create_channel_no_perm": "Media notifikasi {{channel}} belum ada dan Anda tidak punya izin membuatnya. Minta administrator membuatnya lebih dulu",
  ...
  "notification_configuration": {
    ...
    "severities": "Tingkat keparahan yang berlaku",
