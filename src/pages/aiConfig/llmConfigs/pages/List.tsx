...
import { Button, Dropdown, Menu, Space, Switch, Table, Tooltip, Modal, Tag, Alert, message } from 'antd';
                    ...
                    render: (record) => (
                      <Dropdown
                        overlay={
                          <Menu>
                            <Menu.Item>
                              <Button type='link' className='p-0 h-auto' icon={<EditOutlined />} onClick={() => setEditDrawerState({ visible: true, id: record.id })}>
                                {t('common:btn.edit')}
                              </Button>
                            </Menu.Item>
                            <Menu.Item>
