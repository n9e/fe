const en_US = {
  ...
  no_manage_perm: 'No permission to manage; only members of the management teams can operate',
  ...
  scope: {
    ...
    teams_placeholder: 'Select management teams',
  },
  ...
  template: {
    ...
    category: {
      all: 'All',
      observability: 'Observability & incident',
