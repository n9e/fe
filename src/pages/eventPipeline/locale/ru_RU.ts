const ru_RU = {
  ...
  saved_guide: {
    ...
    hint: 'Он ещё не активен — сошлитесь на этот рабочий процесс из правила оповещения или уведомления, чтобы события проходили через него.',
    to_alert_rule: 'К правилам оповещений',
