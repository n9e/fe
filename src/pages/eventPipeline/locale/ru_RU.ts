const ru_RU = {
  ...
  executions: {
    ...
    empty_guide: {
      ...
      desc: 'После срабатывания рабочего процесса по правилу оповещения или уведомления каждое выполнение записывается здесь.',
    },
  },
  test_modal: {
    title: {
  ...
  batch: {
    ...
    delete_enabled_tip: 'Следующие рабочие процессы всё ещё включены. Сначала отключите их, затем удаляйте: {{names}}',
  },
